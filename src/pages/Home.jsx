...
import StudyVideo from '../assets/StudyVideo.mp4'
  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        {/* Heading */}
        <div className="text-center  text-3xl  lg:text-4xl font-semibold">
          Empower Your Future with {" "}
          <HighlightText text={"Coding Skills"} />
        </div>

        {/* Sub Heading */}
        <div className="-mt-3 w-[90%] text-center lg:text-lg text-sm font-bold text-richblack-300">
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        <div className="homepage_bg h-[160px] lg:h-[310px]">
          ...
          <div className=' w-11/12 max-w-maxContent flex flex-col items-center gap-5 mx-auto justify-between'>
            ...
            <div className=' flex flex-row gap-7 text-white mt-2 lg:mt-12'>
              <CTAButton active={true} linkto={'/signup'} >
        ...
        <div className=' mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
          ...
          < div className='flex flex-col lg:flex-row gap-5 mb-10 lg:mt-[95px] '>
       ...
       <div className="relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white">
          ...
          <h1 className="text-center lg:text-4xl text-3xl font-semibold mt-8">
